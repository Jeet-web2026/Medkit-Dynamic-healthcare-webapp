<nav class="fixed-top shadow pb-3 bg-white">
<nav class="navbar navbar-expand-lg py-2 px-lg-5">
    <div class="container-fluid px-lg-5">
        <a class="navbar-brand fw-bold text-primary" style="font-size: 5vh;" href="<?php echo site_url() ?>"><img src="<?php echo get_header_image();?>" alt="logo-img" class="brand-img">Medikit</a>
